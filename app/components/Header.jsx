      ...
      <div class="flex justify-between w-full">
        <div class="flex gap-6 items-center">
          ...
          <ui class="text-sm list-none hidden lg:flex">
            <li class="ml-5 font-bold"><a>Home</a></li>
            <li class="header-list"><a>TV Shows</a></li>
            <li class="header-list"><a>Movies</a></li>
            <li class="header-list"><a>New & Popular</a></li>
            <li class="header-list"><a>My List</a></li>
            <li class="header-list"><a>Browse by Languages</a></li>
          </ui>
        </div>
