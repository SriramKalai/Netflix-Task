  ...
  return (
    <div class="items-center gap-4 hidden lg:flex">
      ...
      <button class="flex group">
        ...
        <span class="ml-0 mt-1 group-hover:rotate-180"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 -960 960 960" fill="#e8eaed"><path d="M480-360 280-560h400L480-360Z" /></svg></span>
      </button>
    </div>
  )
}
...
const Header = () => {
  return (
    <div class="flex px-[4%] h-[68px] items-center z-50 sticky top-0 bg-black">
